      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Bidding and Auctions</h2>
              <div className="space-y-4">
                <p className="text-gray-700">
                  All bids are final and binding. Once placed, a bid cannot be cancelled or modified except as provided in these terms.
                </p>
                <p className="text-gray-700">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-700">
                  All prices are in US Dollars unless otherwise specified. Sales tax will be added to all purchases as required by law.
                </p>
                <p className="text-gray-700">
                  Refunds are provided in accordance with our refund policy, which is incorporated into these terms by reference.
                </p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. Pickup and Delivery</h2>
              <div className="space-y-4">
                <p className="text-gray-700">
                  Orders must be picked up during the specified pickup window. Failure to pick up an order may result in forfeiture 
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 text-gray-700 space-y-2">
                  ...
                  <li>Use automated systems to place bids or manipulate auctions</li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <p className="text-gray-700">
                  THE SERVICE IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS. BIDORAI MAKES NO WARRANTIES, 
                  EXPRESS OR IMPLIED, AND HEREBY DISCLAIMS ALL WARRANTIES, INCLUDING BUT NOT LIMITED TO WARRANTIES 
                  OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
                </p>
                <p className="text-gray-700">
                  Bidorai does not warrant that the Service will be uninterrupted, secure, or error-free, or that defects 
                  will be corrected.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <p className="text-gray-700">
                  IN NO EVENT SHALL BIDORAI BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, 
                  OR PUNITIVE DAMAGES, INCLUDING WITHOUT LIMITATION, LOSS OF PROFITS, DATA, USE, GOODWILL, 
                  OR OTHER INTANGIBLE LOSSES.
                </p>
                <p className="text-gray-700">
                  BIDORAI'S TOTAL LIABILITY TO YOU FOR ANY CLAIMS ARISING OUT OF OR RELATING TO THESE TERMS 
                  OR THE SERVICE SHALL NOT EXCEED THE AMOUNT PAID BY YOU TO BIDORAI IN THE TWELVE MONTHS 
                  PRECEDING THE CLAIM.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                You agree to defend, indemnify, and hold harmless Bidorai and its officers, directors, employees, 
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700">Bidorai Inc.</p>
                <p className="text-gray-700">Email: legal@bidorai.com</p>
                <p className="text-gray-700">Phone: 1-800-BIDORAI</p>
